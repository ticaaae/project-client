...
<head>
  <meta charset="utf-8">
  <link href="<?= site_url('asset') ?>/admin/dist/serbaserbi/logocv.png" rel="shortcut icon">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Icewall admin is super flexible, powerful, clean & modern responsive tailwind admin template with unlimited possibilities.">
  <meta name="keywords" content="admin template, Icewall Admin Template, dashboard template, flat admin template, responsive admin template, web app">
  <meta name="author" content="LEFT4CODE">
  <title><?= $title ?> | CV. Lingga Pratama Teknik</title>
  <!-- BEGIN: CSS Assets-->
    ...
    <div class="block xl:grid grid-cols-2 gap-4">
      ...
      <div class="hidden xl:flex flex-col min-h-screen">
        <a href="" class="-intro-x flex items-center pt-5">
          <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/serbaserbi/logocv.png">
          <span class="text-white text-lg ml-3"> CV.Lingga Pratama Teknik </span>
        </a>
        <div class="my-auto">
          ...
          <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
            Welcome to 
            <br>
            CV. Lingga Pratama Teknik
          </div>
          <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Sign in to Manage all your Maintenance Electronic System</div>
        </div>
      </div>
      <!-- END: Login Info -->
      <!-- BEGIN: Login Form -->
